<template>
      ...
      <div class="overlay">
        <div class="overlay-panel overlay-left">
          <div class="logo-container">
            <img :src="isLogo" alt="Logo" class="logo" />
          </div>
          <h1>Welcome Back!</h1>
          <p>To keep connected with us please login with your personal info</p>
          <button class="ghost" id="logIn" @click="switchToLogin">Log In</button>
        </div>
  ...
  <footer>
    <p>Created with <i class="fa fa-heart"></i> by: Jana Aera Senoc | Kimberly Suarez</p>
  </footer>
</template>

<script>
import isLogo from '@/assets/img/is.png'
...
.overlay {
  background: #27b6a3;
  background: -webkit-linear-gradient(to right, #1bada6, #20afa8);
  background: linear-gradient(to right, #1eb1a4, #16b3b3);
